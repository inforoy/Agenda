...
import com.vectorsf.fragment.Fragment_Lista;
...
public class Activity_Principal extends FragmentActivity implements Fragment_Lista.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Se comprueba que exista el framelayout framelayout_contenedor_entrada. 
		//Si existe estaremos usando activity_dospaneles.xml, sino estaremos usando activity_listado.xml 
		if (findViewById(R.id.framelayout_contenedor_detalle) != null) {
			...
			// Estaremos usando activity_dospaneles.xml
			dosFragmentos = true;
		}
	}
